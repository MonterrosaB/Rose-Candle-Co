    ...
    <div className="relative z-20 max-w-lg mx-auto mt-20 bg-white p-8 rounded-2xl shadow-lg text-center font-[Poppins]">
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <p className="text-[#86918C] mb-4">
          Hemos enviado un código a tu correo electrónico para comprobar la
        ...
        <button
          type="submit"
          disabled={isLoading || resendLoading}
          className="py-2 px-6 mt-2 mb-4 border border-[#C2A878] rounded-lg text-[#C2A878] font-medium cursor-pointer transition duration-200 hover:bg-[#C2A878] hover:text-[#F7F5EE]"
        >

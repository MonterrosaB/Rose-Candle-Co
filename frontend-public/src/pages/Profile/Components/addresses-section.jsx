  ...
  const [addresses] = useState([
    {
      ...
      type: "home",
      title: "Casa",
      address: "Calle El Mirador 12, Colonia Escalón, San Salvador, El Salvador",
      isDefault: true,
    },
    {
      id: 2,
      type: "work",
      title: "Oficina",
      address: "Boulevard de Los Héroes 2500, Edificio Torre Empresarial, San Salvador, El Salvador",
      isDefault: false,
    },
  ])
    ...
    <div className="space-y-8">
          ...
          >
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center space-x-3">
                <div
                  className={`p-3 rounded-xl ${address.type === "home" ? "bg-blue-100" : "bg-purple-100"} shadow-lg`}
                >
                  {address.type === "home" ? (
      ...
      {addresses.length === 0 && (
        <div className="bg-white/60 backdrop-blur-sm rounded-3xl p-12 text-center shadow-xl border border-rose-100">
          ...
          <h3 className="text-2xl font-bold text-gray-800 mb-4">No tienes direcciones guardadas</h3>
          <p className="text-gray-600 mb-8">Agrega una dirección para facilitar tus compras futuras</p>
